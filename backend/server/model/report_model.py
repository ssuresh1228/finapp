...
class Report(Document):
    ...
    generated_on: Annotated[datetime.datetime, "when report was generated"] = Field(default = datetime.datetime.now())
...
class AverageIncome(BaseModel):
    ...
    end_date: Annotated[date, "avg income: starting date"]
...
class AverageExpenses(BaseModel):
    ...
    end_date: Annotated[date, "avg expenses: starting date"]
...
class TotalExpenses(BaseModel):
    start_date: Annotated[date, "total expenses: starting date"]
    end_date: Annotated[date, "total expenses: starting date"]
...
class TotalIncome(BaseModel):
    ...
    end_date: Annotated[date, "total income: ending date"]
...
class Data(BaseModel):
    ...
    end_date: Annotated[date, "end date of associated report"]